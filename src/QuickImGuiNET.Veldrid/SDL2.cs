...
public static unsafe class SDL2Extensions
{
    ...
    public delegate int D_SDL_GetDisplayUsableBounds(int displayIndex, Rectangle* rect);

    public delegate uint D_SDL_GetGlobalMouseState(int* x, int* y);
    ...
    public static D_SDL_SetWindowIcon SDL_SetWindowIcon =
        Sdl2Native.LoadFunction<D_SDL_SetWindowIcon>("SDL_SetWindowIcon");

    public static D_SDL_GetNumVideoDisplays SDL_GetNumVideoDisplays =
        Sdl2Native.LoadFunction<D_SDL_GetNumVideoDisplays>("SDL_GetNumVideoDisplays");

    public static D_SDL_GetDisplayUsableBounds SDL_GetDisplayUsableBounds =
        Sdl2Native.LoadFunction<D_SDL_GetDisplayUsableBounds>("SDL_GetDisplayUsableBounds");

    public static D_SDL_RaiseWindow SDL_RaiseWindow = Sdl2Native.LoadFunction<D_SDL_RaiseWindow>("SDL_RaiseWindow");

    public static D_SDL_GetGlobalMouseState SDL_GetGlobalMouseState =
        Sdl2Native.LoadFunction<D_SDL_GetGlobalMouseState>("SDL_GetGlobalMouseState");
}